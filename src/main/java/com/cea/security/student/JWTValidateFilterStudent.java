...
public class JWTValidateFilterStudent extends BasicAuthenticationFilter {
    ...
    public JWTValidateFilterStudent(AuthenticationManager authenticationManager, ConfigProperties configProperties) {
        super(authenticationManager);
        this.TOKEN_PASS = configProperties.getProperty("token.pass.student");
    }
    ...
    private UsernamePasswordAuthenticationToken getAuthenticationToken(String token) {
        String student = JWT.require(Algorithm.HMAC512(this.TOKEN_PASS))
                .build()
                .verify(token)
                .getSubject();
